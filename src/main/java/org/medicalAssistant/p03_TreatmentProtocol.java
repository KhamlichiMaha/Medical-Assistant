...
public class p03_TreatmentProtocol {
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        RunCreateRequest runCreateRequest = RunCreateRequest.builder()
                ...
                .instructions("Provide a step by step guide to perform the chosen treatment. " +
                        "Exclude equipment listing and patient interactions.")
                .build();
